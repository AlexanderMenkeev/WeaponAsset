...
public class Projectile : MonoBehaviour
{
    ...
    public void ReadDataFromBlackBox() {
        ...
        _saturation = Mathf.Lerp(0.9f, 1f, (float)_outputArr[3]);
        _brightness = Mathf.Lerp(0.9f, 1f, (float)_outputArr[4]);
        
        _maxSpeed = Mathf.Lerp(MinSpeed, MaxSpeed, (float)_outputArr[5]);
        _force = Mathf.Lerp(MinForce, MaxForce, (float)_outputArr[6]);
