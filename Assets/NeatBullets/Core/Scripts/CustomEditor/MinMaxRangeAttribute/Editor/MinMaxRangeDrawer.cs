...
{
	[CustomPropertyDrawer(typeof(global::NeatBullets.Core.Scripts.CustomEditor.MinMaxRangeAttribute.MinMaxRangeAttribute))]
	internal class MinMaxRangeDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			if (attribute is not global::NeatBullets.Core.Scripts.CustomEditor.MinMaxRangeAttribute.MinMaxRangeAttribute minMaxAttribute)
			{
